        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="flex items-center space-x-1 px-3 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700"
            >
            ...
            {filteredTranslations.map((translation) => (
              <div
                ...
                className={`p-4 hover:bg-gray-50 cursor-pointer ${
                  selectedTranslation?.id === translation.id ? 'bg-primary-50 border-l-4 border-primary-500' : ''
                }`}
                ...
                <div className="grid grid-cols-12 gap-4 items-center">
                  ...
                  <div className="col-span-2">
                    <select
                      ...
                      className={`px-2 py-1 text-xs font-medium rounded-full border-0 ${getStatusColor(translation.status)}`}
                    >
                      <option value="Draft">Draft</option>
                      <option value="Validated">Validated</option>
                      <option value="Approved">Approved</option>
